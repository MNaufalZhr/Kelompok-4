...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let influx_url = "http://localhost:8086/api/v2/write?org=ITS&bucket=monitoring&precision=s";
    let token = "UtqbpEm6C7kBtvtkQVyjH_Vjor8rQn9styV5JrnqhQznbWqvRJvPDAR9jOL5Yk_ah_JwxcqrIiELh7DxrbM7RA==";
